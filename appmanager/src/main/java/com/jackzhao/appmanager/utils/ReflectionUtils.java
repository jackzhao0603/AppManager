...
/**
 * Created by chengkai_tao on 2016/8/15.
 */
public class ReflectionUtils {
    ...
    public static Object newInstance(String className, Object[] parameters, Class[] parameterTypes) {
        try {
            Class clazz = Class.forName(className);
            Constructor constructor = clazz.getDeclaredConstructor(parameterTypes);
            constructor.setAccessible(true);
    ...
    public static Object invoke(String className, String methodName, Object instance, Object[] parameters, Class[] parameterTypes) {
        try {
            ...
            Log.w(TAG, "invoke(clazz=" + className + ") error", e);
            return null;
        }
    }
